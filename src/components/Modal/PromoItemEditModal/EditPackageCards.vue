<template>
  <form v-if="editedItem">
    ...
    <div v-for="(packageCard, index) in editedItem.items" :key="index" class="item-box">
      <div class="flex-item">
      ...
      <div class="item">
        <b># 메인 색깔을 정해주세요.</b>
        <input v-model="packageCard.mainColor" type="color" />
      </div>
      <div class="item">
        <b># 식별자를 입력해주세요.</b>
        <textarea v-model="packageCard.identifier" />
      </div>
      <div class="item">
        <b># 타이틀을 입력해주세요.</b>
        <textarea v-model="packageCard.title" />
      </div>
      <div class="item">
        <b># 서브타이틀을 입력해주세요.</b>
        <textarea v-model="packageCard.subTitle" />
      </div>
      <div class="item descriptions">
        ...
        <div
          v-for="(description, dIndex) in packageCard.descriptions"
          :key="dIndex"
          class="description"
        >
      ...
      <div class="item descriptions">
        ...
        <div v-for="(button, bIndex) in packageCard.buttons" :key="bIndex" class="description">
          <div class="flex-item">
